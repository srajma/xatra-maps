...
xatra.Flag(label="SUVARṆABHŪMĪ", value=SEA)
xatra.Flag(label="MEDITERRANEAN", value=MEDITERRANEAN)
xatra.Flag(label="GULF", value=GULF)
...
if __name__ == "__main__":
    ...
    xatra.show(out_json="../maps/sea.json", out_html="../maps/sea.html")
